...
const UserDashboard = ({ user: propUser, onLogout }) => {
  ...
  const renderProfileView = () => (
    <div
      className="dashboard-card profile-view-card"
      style={{
            ...
            >
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
                <div style={{ display: 'flex', alignItems: 'flex-start', gap: '12px' }}>
                  <Building
                    size={18}
                    style={{ color: '#4f46e5', marginTop: '2px', flexShrink: 0 }}
                  />
      ...
      <form onSubmit={handleSaveProfile} className="dashboard-form">
        <div className="form-grid">
          <div className="form-group">
            <label>
              <User size={16} className="icon" /> Founder Name *
            </label>
            <input
              type="text"
              name="founderName"
          ...
          <div className="form-group">
            <label>
              <Building size={16} className="icon" /> Startup Name *
            </label>
            <input
              type="text"
              name="startupName"
          ...
          <div className="form-group">
            <label>
              <Briefcase size={16} className="icon" /> Industry *
            </label>
            <select
              name="industry"
          ...
          <div className="form-group">
            <label>
              <Rocket size={16} className="icon" /> Current Stage *
            </label>
          ...
          <div className="form-group">
            <label>
              <Calendar size={16} className="icon" /> Founded Year
            </label>
            <input
              type="number"
              name="foundedYear"
          ...
          <div className="form-group">
            <label>
              <Users size={16} className="icon" /> Team Size
            </label>
          ...
          <div className="form-group">
            <label>
              <TrendingUp size={16} className="icon" /> Monthly Revenue
            </label>
            <select
              name="monthlyRevenue"
        ...
        <div className="form-group">
          <label>
            <Target size={16} className="icon" /> Startup Description *
          </label>
          <textarea
            name="description"
        ...
        <button type="submit" className="save-btn" disabled={loading}>
          ...
          <span>
            {loading
              ...
              : profileExists
                ? 'Update Profile'
                : 'Save Profile & Get Personalized Guidance'}
          </span>
        </button>
      </form>
    </div>
      ...
      <div className="dashboard-layout">
        <div className={`sidebar ${isSidebarOpen ? 'sidebar-open' : ''}`}>
          <div className="sidebar-header">
            <img src={img2} alt="Company Logo" className="sidebar-logo" />
          ...
          <div className="sidebar-menu">
            ...
            <button className="sidebar-item" onClick={handleHomeNavigation}>
              <Home size={20} />
              <span>Home</span>
            </button>
